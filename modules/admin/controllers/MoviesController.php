...
use app\models\MoviesImgUpload;
use app\models\MoviesUpload;
use Yii;
...
class MoviesController extends Controller
{
    ...
    {
        $model = new Movies();
        $image = new MoviesImgUpload();
        $upload = new MoviesUpload();
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            $fileMovie = UploadedFile::getInstance($upload, 'movie');

            $model->saveMovie($upload->uploadFile($fileMovie));
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            $model->saveMovie($upload->updateMovie($fileMovie, $model->movie));
